...
Total persisted: 5140 cells — 640 before COS-16, plus 2400 from its first two arms and interrupted ablation, plus 1500 from the retried single-edit arms and the first E1+E2+E3 attempt, plus 600 from the two clean arms that shipped it (every attempted cell writes a row, errored or not; see `20-25-32` and `02-02-28` above). Improve-loop cells before COS-3 are additional and
