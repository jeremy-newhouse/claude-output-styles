...
**Next issue: COS-14** — queue order for campaign 2 confirmed by the user on
...
- 2026-08-17 — session 12: **COS-13 resolved, $0.** Ran the fixture before
  ...
  **red on a clean checkout**, `priceOrder` asserting 966 against the code's 965.
  ...
  `npm --prefix harness test` 112 → 116; `audit` exit 0; `lore check` exit 0.
  Spend $0.
