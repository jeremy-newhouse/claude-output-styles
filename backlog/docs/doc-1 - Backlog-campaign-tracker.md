...
COS-19, re-measures the headline four-tier table. Session 27 measured its own
throughput rather than reusing session 20's estimate of 26.5: two 300-cell arms
at concurrency 12 took 9m39s each (start stamps `03-03-26` and `03-13-05`, last
row written `03-22-44`), i.e. 600 cells in 19m18s, **31 cells a minute** with no
errored cell. Size against 31 until a session measures otherwise.
