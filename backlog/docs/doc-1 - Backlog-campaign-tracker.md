...
**Next issue: COS-17** — Campaign 2 item 11. Re-measure beginner on Haiku and
Fable after the rewrite. Queue order was confirmed by the user on 2026-08-17 (see
the Campaign 2 section below) and item 10, COS-18, is now Resolved, so the cursor
advances in that confirmed order. Do not re-ask before taking it.

The user kept COS-17 as its own session rather than folding it into COS-19,
because "it answers sooner and cheaper, and COS-19 can reuse its data".

**Throughput is not 31 cells a minute any more, and sizing against it will
mislead.** Session 28 measured its own and it moved by an order of magnitude
within one session: the 600-cell diagnostic arm ran at roughly 5 cells a minute,
and the reserve retry degraded to about **0.7** before being stopped. Session
27's 31 was measured on beginner, whose replies are short; intermediate and
advanced write longer ones and the judge call, not the cell, is the bottleneck.
`reserve-agentic-session` alone costs ~45 seconds a cell before its judge call.
**Size a reserve arm in hours, not minutes, and measure throughput early enough
to abandon cheaply.**

**Two usage ceilings were hit in this campaign's last two sessions**, and they are
different. Session 27's was the 5-hour window. Session 28 hit the **monthly spend
limit** — 163 of 300 cells in one arm, taking all 150 Sonnet cells — which does
not clear by waiting a few hours. It had cleared by 2026-08-26, established by a
deliberate 2-cell probe (`2026-08-26T13-20-50`) rather than by assuming. Probe
before committing 300 cells to a limit you have already hit once.
