...
**Next issue: COS-20** — queue order for campaign 2 confirmed by the user on
...
Campaign 2 items 1 to 6 (COS-12, COS-10, COS-11, COS-13, COS-14, COS-9) are
resolved; the cursor has advanced to item 7.
...
- 2026-08-17 — session 17: took **COS-9**, campaign 2 item 6, in order, after two
  ...
  Suite 131 → **133**; `audit` exit 0; `lore check` exit 0.
